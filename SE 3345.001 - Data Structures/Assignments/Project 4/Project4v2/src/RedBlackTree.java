...
public class RedBlackTree<AnyType extends Comparable<? super AnyType>>
{
     ...
     */
    public int compare( AnyType item, RedBlackNode<AnyType> t )
    {
        if( t == header )
            return 1;
        else
     ...
     */
    public void handleReorient( AnyType item )
    {
            // Do the color flip
        current.color = RED;
     ...
     */
    public RedBlackNode<AnyType> rotate( AnyType item, RedBlackNode<AnyType> parent )
    {
        if( compare( item, parent ) < 0 )
     ...
     */
    public RedBlackNode<AnyType> rotateWithLeftChild( RedBlackNode<AnyType> k2 )
    {
     ...
     */
    public RedBlackNode<AnyType> rotateWithRightChild( RedBlackNode<AnyType> k1 )
    {
    ...
    public RedBlackNode<AnyType> header;
